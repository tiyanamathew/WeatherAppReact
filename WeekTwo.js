    ...
    <div>
      <div class="container mt-3">
        <div class="row mt-3">
          <form onSubmit={handleSubmit}>
            ...
            <input type="submit" value="Current" class="btn" />
          </form>
      ...
      <div class="container mt-3">
        <div class="row mt-3">
          <div class="col">
            <div class="row no-gutters">
              <div class="col-12">
                <div class="card-body">
                  <p id="city" class="card-text sunny">
                    {message} {temperature}
                  </p>
                </div>
              </div>
        ...
        <div>
          <div class="col mb-3">
            <div class="card-body">
              <h2 class="its">It is...</h2>
              <p class="sunny">Sunny! Don't forget your sunscreen. ☀️</p>

              <h2 class="its" id="weather-description">
                Precipitation:
      ...
      <div class="row" id="forecast">
        <div class="col five">
          <div class="card-body">
            ...
            <img
              ...
              alt="weather"
            />
            <p class="card-text five">17˚ - 27˚</p>
          </div>
        </div>
        <div class="col five">
          <div class="card-body">
            ...
            <img
              ...
              alt="weather"
            />
            <p class="card-text five">19˚ - 28˚</p>
          </div>
          {/*  */}
        </div>
        <div class="col five">
          <div class="card-body">
            ...
            <p class="card-text five">20˚ - 26˚</p>
          </div>
        </div>
        <div class="col five">
          <div class="card-body">
        ...
        <div class="col five">
          <div class="card-body">
            ...
            <p class="card-text five">21˚ - 24˚</p>
          </div>
        </div>
      </div>
      <p id="github">
        <a href="https://github.com/tiyanamathew/week3">Link to GitHub</a>
      </p>
    </div>
  );
}
